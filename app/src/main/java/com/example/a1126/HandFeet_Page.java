...
public class HandFeet_Page extends AppCompatActivity {
    ...
    private void permissionCheck()
    {
        ...
        {
            ActivityCompat.requestPermissions(HandFeet_Page.this, new String[] {Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.RECORD_AUDIO}, 1);
        }
    }
    ...
    class Tai2Chi extends AsyncTask<String , Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (s != null) {
                ...
                if(resultText.getText().toString().equals("手腕痛") || resultText.getText().toString().equals("手痛"))
                {
                    result_txt.setText("症狀:手腕疼痛\n可能狀況:關節炎、扭傷、腱鞘炎\n解決方法:尋求骨科醫師協助，進行藥物治療和物理治療");
                }
                else if(resultText.getText().toString().equals("屁股痛") )
                {
                    result_txt.setText("症狀:髖關節疼痛發熱\n可能狀況:化膿性關節炎\n解決方法:尋求骨科醫師協助，進行藥物治療");
                }
                else if(resultText.getText().toString().equals("肩膀痛") )
                {
                    result_txt.setText("症狀:肩膀關節疼痛\n可能狀況:五十肩\n解決方法:尋求骨科醫師協助，進行藥物治療和物理治療");
                }
                else if(resultText.getText().toString().equals("膝蓋痛") )
                {
                    result_txt.setText("症狀:膝關節疼痛\n可能狀況:關節炎\n解決方法:避免過度使用膝蓋，並尋求骨科醫師協助，進行藥物治療和物理治療");
                }
                else if(resultText.getText().toString().equals("手痛")  || resultText.getText().toString().equals("手指痛"))
                {
                    result_txt.setText("症狀:手指疼痛無發張開\n可能狀況:板機指\n解決方法:可熱敷減輕疼痛，若很嚴重請尋求骨科醫師協助，進行藥物治療和物理治療");
                }
                else if(resultText.getText().toString().equals("關節痛")  || resultText.getText().toString().equals("骨頭痛"))
                {
                    result_txt.setText("症狀:早上時關節疼痛\n可能狀況:類風濕關節炎\n解決方法:進行適度、輕微的活動，並持續配合醫師及物理治療師的治療");
                }
                return;
