...
public class Head_Page extends AppCompatActivity {
    ...
    private void permissionCheck()
    {
        ...
        {
            ActivityCompat.requestPermissions(Head_Page.this, new String[] {Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.RECORD_AUDIO}, 1);
        }
    }
    ...
    class Tai2Chi extends AsyncTask<String , Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (s != null) {
                ...
                if(resultText.getText().toString().equals("頭脹痛"))
                {
                    result_txt.setText("症狀:頭脹痛\n可能狀況:高血壓、輕微頭痛\n解決方法:若為高血壓族群請按時服藥回診，若為輕微頭痛則適度休息，避免吹冷風");
                }
                else if(resultText.getText().toString().equals("偏頭痛") || resultText.getText().toString().equals("左邊頭痛")  || resultText.getText().toString().equals("右邊頭痛"))
                {
                    result_txt.setText("症狀:偏頭痛\n可能狀況:偏頭痛\n解決方法:避免風寒、噪音並臥床休息，亦可使用溫水浸泡手部，促進血液循和緩解頭痛");
                }
                else if(resultText.getText().toString().equals("脖子痛")  || resultText.getText().toString().equals("太陽穴痛"))
                {
                    result_txt.setText("症狀:太陽穴、脖子疼痛\n可能症狀:緊縮性頭痛\n解決方法:放鬆心情，避免長時間維持通一個姿勢，若很嚴重請尋求醫師協助，服用肌肉鬆弛劑等藥物");
                }
                else if(resultText.getText().toString().equals("發燒") )
                {
                    result_txt.setText("症狀:急性頭痛、發燒\n可能症狀:感染頭痛\n解決方法:尋求醫師協助，服用感冒藥物");
                }
                else if(resultText.getText().toString().equals("看不清楚")  || resultText.getText().toString().equals("頭痛"))
                {
                    result_txt.setText("症狀:頭痛附帶視力模糊\n可能症狀:青光眼、腦瘤\n解決方法:請立即尋求醫師協助，確認病因");
                }
                else if(resultText.getText().toString().equals("流鼻水")  || resultText.getText().toString().equals("頭痛"))
                {
                    result_txt.setText("症狀:頭痛伴隨流鼻水\n可能症狀:流感、一般感冒\n解決方法:尋求醫師協助，服用感冒藥物");
                }
                return;
